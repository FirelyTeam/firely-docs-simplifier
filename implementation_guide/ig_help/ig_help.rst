...
Implementation Guide editor help
================================

.. note::

   This help is also shown inside the Implementation Guide editor on Simplifier
   and is kept canonical there. See https://simplifier.net for the live version.
...
Please see the `best practices on writing a FHIR Implementation Guide <https://build.fhir.org/ig/FHIR/ig-guidance/branches/master/best-practice.html>`__ for more general guidance on what your Guide should cover.
